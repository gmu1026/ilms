        	...
        	<div class="container_16 clearfix" id="actualbody">
				<div class="grid_16 widget first">
	    			...
	    			<div class="widget_body">
						<form id="add_form" method="post" action="/sw">
							<table>
							    <tr>
							        <td style="width: 5px;"></td>
							        <td width="15%"><label for="integer">구분</label></td>
							        <td>
						                ...
						                <span class="infobar"><div id="division_notice_area" align="left"></div></span>
							        </td>
							    </tr>
							    <tr>
							        <td></td>
							        <td><label for="required_field">소프트웨어 이름</label></td>
							        <td>
					                	<input type="text" name="name"><br/>
						                <span class="infobar"><div id="swName_notice_area" align="left"></div></span>
							        </td>
							    </tr>
							    <tr>
							        <td></td>
							        ...
							        <td>
						                <input type="text" name="useDept" id="sw_useDept"><br/>
							        </td>
							    </tr>
							    <tr>
							        <td></td>
							        ...
							        <td>
						                <input type="text" name="usage" id="sw_usage"><br/>
							        </td>
							    </tr>
							    <tr>
							        <td></td>
							        ...
							        <td>
						                <input type="text" name="serialNumber" id="sw_serialNnumber"><br/>
							        </td>
							    </tr>
							    <tr>
							    	<td></td>
				...
				<br/>
	   			<div  style="margin-right: 20px;">
	   				<a class="btn right medium" onclick="location.href='/sw'"><span>목록</span></a>
